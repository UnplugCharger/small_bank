...
INSERT INTO entries (account_id, amount, created_at) VALUES ($1, $2, $3) RETURNING id, account_id, amount, created_at
`
...
SELECT id, account_id, amount, created_at FROM entries WHERE account_id = $1 ORDER BY created_at LIMIT $2 OFFSET $3
`
